...
#'directory
#'@param data a list of input data variables (order must match TPL file)
#'@param params a list of starting parameter values (order must match TPL file)
...
#'@param profpars (character) vector of names of parameters to profile
...
#'@param admb_errors how to treat ADMB errors (in either compilation or run): use at your own risk!
